...
<main class="m-5">
    <section class="text-center flex flex-col items-center justify-center gap-2">
        <div class="flex items-center gap-3">
            <h1 class="font-bold text-4xl relative"><?= $album['namaAlbum'] ?></h1>
            <div class="w-fit h-fit font-bold bg-zinc-200 text-zinc-500 px-2 text-xl rounded-lg"><?= count($fotos) ?></div>
        </div>
